...
const std::array<UISettings::Shortcut, 38> QtConfig::default_hotkeys {{
     ...
     {QStringLiteral("Exit Auralis"),              QStringLiteral("Main Window"), {QStringLiteral("Ctrl+Q"), Qt::WindowShortcut}},
...
void QtConfig::ReadWebServiceValues() {
    ...
    NetSettings::values.web_api_url =
        ReadSetting(QStringLiteral("web_api_url"), QStringLiteral("https://api.auralis-emulator.org"))
            .toString()
            .toStdString();
...
void QtConfig::SaveWebServiceValues() {
    ...
    WriteSetting(QStringLiteral("web_api_url"),
                 ...
                 QStringLiteral("https://api.auralis-emulator.org"));
