...
package com.auralis.emulator.features.settings.utils
...
import com.auralis.emulator.features.settings.model.SettingSection
import com.auralis.emulator.features.settings.model.Settings.SettingsSectionMap
import com.auralis.emulator.features.settings.model.StringSetting
import com.auralis.emulator.features.settings.ui.SettingsActivityView
import com.auralis.emulator.utils.BiMap
import com.auralis.emulator.utils.DirectoryInitialization.userDirectory
...
object SettingsFile {
    ...
    fun readFile(
        ...
        try {
            val context: Context = AuralisApplication.appContext
    ...
    fun getSettingsFile(fileName: String): DocumentFile {
        val root = DocumentFile.fromTreeUri(AuralisApplication.appContext, Uri.parse(userDirectory))
