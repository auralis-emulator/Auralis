...
This is a GodMode9 script that dumps all the keys and other related secrets that Auralis needs from a real 3DS.
...
4. Power off your system and copy the "gm9/aes_keys.txt" and "gm9/seeddb.bin" files off of your SD card into "(Auralis directory)/sysdata/".
