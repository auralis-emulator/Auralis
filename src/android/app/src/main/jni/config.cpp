...
void Config::ReadValues() {
    ...
    // Workaround to map Android setting for enabling the frame limiter to the format Auralis expects
    ...
    NetSettings::values.web_api_url =
        sdl2_config->GetString("WebService", "web_api_url", "https://api.auralis-emulator.org");
