...
import com.auralis.emulator.adapters.HomeSettingAdapter
import com.auralis.emulator.databinding.DialogSoftwareKeyboardBinding
import com.auralis.emulator.databinding.FragmentHomeSettingsBinding
...
import com.auralis.emulator.model.HomeSetting
...
import com.auralis.emulator.viewmodel.DriverViewModel
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList = listOf(
            ...
            HomeSetting(
                ...
                R.drawable.ic_home,
                { PermissionsHandler.compatibleSelectDirectory(mainActivity.openAuralisDirectory) },
    ...
    private fun shareLog() {
        ...
        val currentLog = logDirectory?.findFile("auralis_log.txt")
        val oldLog = logDirectory?.findFile("auralis_log.old.txt")
