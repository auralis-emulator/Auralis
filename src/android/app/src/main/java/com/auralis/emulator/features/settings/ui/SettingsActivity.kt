...
import com.auralis.emulator.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity(), SettingsActivityView {
    ...
    fun onSettingsReset() {
        ...
        val editor =
            PreferenceManager.getDefaultSharedPreferences(AuralisApplication.appContext).edit()
        ...
        if (DirectoryInitialization.setAuralisUserDirectory()) {
            AuralisApplication.documentsTree.setRoot(Uri.parse(DirectoryInitialization.userPath))
            NativeLibrary.createConfigFile()
        } else {
            throw IllegalStateException("Auralis directory unavailable when accessing config file!")
        }
