macro(generate_build_info)
    ...
    # Auralis: allow a fixed version override (independent of upstream tags).
    if (EXISTS "${SRC_DIR}/AURALIS-VERSION")
        file(READ "${SRC_DIR}/AURALIS-VERSION" AURALIS_VERSION_RAW)
        string(STRIP "${AURALIS_VERSION_RAW}" AURALIS_VERSION)
        if (NOT "${AURALIS_VERSION}" STREQUAL "")
            set(BUILD_VERSION "${AURALIS_VERSION}")
            set(BUILD_FULLNAME "${AURALIS_VERSION}")
        endif()
    endif()
