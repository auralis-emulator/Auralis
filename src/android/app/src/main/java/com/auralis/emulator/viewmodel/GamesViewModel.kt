...
package com.auralis.emulator.viewmodel
...
class GamesViewModel : ViewModel() {
    ...
    init {
        ...
        val storedGames = PreferenceManager.getDefaultSharedPreferences(AuralisApplication.appContext)
        ...
        if (storedGames!!.isNotEmpty()) {
            ...
            storedGames.forEach {
                ...
                val gameExists =
                    DocumentFile.fromSingleUri(AuralisApplication.appContext, Uri.parse(game.path))
                        ?.exists()
                if (gameExists == true) {
