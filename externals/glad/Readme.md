...
2. Input the currently supported extensions from [here](https://github.com/auralis-emu/auralis/blob/master/externals/glad/include/glad/glad.h#L9), plus any new required extensions.
