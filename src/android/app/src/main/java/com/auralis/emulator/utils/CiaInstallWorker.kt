...
import com.auralis.emulator.NativeLibrary.InstallStatus
import com.auralis.emulator.R
import com.auralis.emulator.utils.FileUtil.getFilename

class CiaInstallWorker(
    val context: Context,
    params: WorkerParameters
) : Worker(context, params) {
    private val GROUP_KEY_CIA_INSTALL_STATUS = "com.auralis.emulator.CIA_INSTALL_STATUS"
