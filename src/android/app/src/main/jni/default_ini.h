...
# from a controller device to the client program. Auralis has a client that can connect and read
...
[System]
# The system model that Auralis will try to emulate
...
# The system region that Auralis will use during emulation
# -1: Auto-select (default), 0: Japan, 1: USA, 2: Europe, 3: Australia, 4: China, 5: Korea, 6: Taiwan
region_value =

# The system language that Auralis will use during emulation
...
# Immediately commits the debug log to file. Use this if Auralis crashes and the log output is being cut.
instant_debug_log =
...
# URL for Web API
web_api_url =
# Username and token for Auralis Web Service
citra_username =
citra_token =
)";
}
