...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    s_savestate_info_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("com/auralis/emulator/NativeLibrary$SaveStateInfo")));
    s_core_error_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("com/auralis/emulator/NativeLibrary$CoreError")));

    // Initialize NativeLibrary
    const jclass native_library_class = env->FindClass("com/auralis/emulator/NativeLibrary");
    s_native_library_class = reinterpret_cast<jclass>(env->NewGlobalRef(native_library_class));
    s_on_core_error = env->GetStaticMethodID(
        s_native_library_class, "onCoreError",
        "(Lcom/auralis/emulator/NativeLibrary$CoreError;Ljava/lang/String;)Z");
    ...
    // Initialize Cheat
    const jclass cheat_class = env->FindClass("com/auralis/emulator/features/cheats/model/Cheat");
    ...
    // Initialize GameInfo
    const jclass game_info_class = env->FindClass("com/auralis/emulator/model/GameInfo");
    ...
    s_disk_cache_progress_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("com/auralis/emulator/utils/DiskShaderCacheProgress")));
    jclass load_callback_stage_class =
        env->FindClass("com/auralis/emulator/utils/DiskShaderCacheProgress$LoadCallbackStage");
    s_disk_cache_load_progress = env->GetStaticMethodID(
        s_disk_cache_progress_class, "loadProgress",
        "(Lcom/auralis/emulator/utils/DiskShaderCacheProgress$LoadCallbackStage;II)V");
    ...
    s_cia_install_helper_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("com/auralis/emulator/utils/CiaInstallWorker")));
    ...
    jclass cia_install_status_class =
        env->FindClass("com/auralis/emulator/NativeLibrary$InstallStatus");
