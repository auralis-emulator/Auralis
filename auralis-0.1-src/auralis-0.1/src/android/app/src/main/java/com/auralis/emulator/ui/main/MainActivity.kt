...
import com.auralis.emulator.contracts.OpenFileResultContract
import com.auralis.emulator.databinding.ActivityMainBinding
import com.auralis.emulator.features.settings.model.Settings
import com.auralis.emulator.features.settings.model.SettingsViewModel
import com.auralis.emulator.features.settings.ui.SettingsActivity
import com.auralis.emulator.features.settings.utils.SettingsFile
import com.auralis.emulator.fragments.GrantMissingFilesystemPermissionFragment
import com.auralis.emulator.fragments.SelectUserDirectoryDialogFragment
import com.auralis.emulator.fragments.UpdateUserDirectoryDialogFragment
import com.auralis.emulator.utils.BuildUtil
import com.auralis.emulator.utils.CiaInstallWorker
import com.auralis.emulator.utils.AuralisDirectoryHelper
import com.auralis.emulator.utils.AuralisDirectoryUtils
import com.auralis.emulator.utils.DirectoryInitialization
import com.auralis.emulator.utils.FileBrowserHelper
import com.auralis.emulator.utils.InsetsHelper
import com.auralis.emulator.utils.RefreshRateUtil
import com.auralis.emulator.utils.PermissionsHandler
import com.auralis.emulator.utils.ThemeUtil
...
class MainActivity : AppCompatActivity(), ThemeProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AuralisDirectoryUtils.attemptAutomaticUpdateDirectory()
        splashScreen.setKeepOnScreenCondition {
            !DirectoryInitialization.areAuralisDirectoriesReady() &&
                    PermissionsHandler.hasWriteAccess(this) &&
                    !AuralisDirectoryUtils.needToUpdateManually()
        }
    ...
    private fun checkUserPermissions() {
        ...
        if (!PermissionsHandler.hasWriteAccess(this)) {
            ...
            return
        } else if (AuralisDirectoryUtils.needToUpdateManually()) {
    ...
    private fun createOpenAuralisDirectoryLauncher(
        ...
        return registerForActivityResult(ActivityResultContracts.OpenDocumentTree()) { result: Uri? ->
            ...
            AuralisDirectoryHelper(this@MainActivity, permissionsLost)
                .showAuralisDirectoryDialog(result, buttonState = {})
        }
    }

    val openAuralisDirectory = createOpenAuralisDirectoryLauncher(permissionsLost = false)
    val openAuralisDirectoryLostPermission = createOpenAuralisDirectoryLauncher(permissionsLost = true)
