...
import com.auralis.emulator.display.ScreenLayout
import com.auralis.emulator.display.StereoMode
import com.auralis.emulator.display.StereoWhichDisplay
...
import com.auralis.emulator.features.settings.model.StringSetting
import com.auralis.emulator.features.settings.model.view.DateTimeSetting
import com.auralis.emulator.features.settings.model.view.HeaderSetting
import com.auralis.emulator.features.settings.model.view.InputBindingSetting
import com.auralis.emulator.features.settings.model.view.RunnableSetting
...
import com.auralis.emulator.fragments.ResetSettingsDialogFragment
import com.auralis.emulator.utils.BirthdayMonth
...
class SettingsFragmentPresenter(private val fragmentView: SettingsFragmentView) {
    ...
    fun onViewCreated(settingsAdapter: SettingsAdapter) {
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(AuralisApplication.appContext)
        loadSettingsList()
    }
    ...
    private fun addSystemSettings(sl: ArrayList<SettingsItem>) {
        ...
        sl.apply {
            val usernameSetting = object : AbstractStringSetting {
                ...
                override val defaultValue = "AURALIS"
            }
