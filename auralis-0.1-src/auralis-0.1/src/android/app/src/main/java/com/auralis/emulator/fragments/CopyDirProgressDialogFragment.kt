...
import com.auralis.emulator.databinding.DialogCopyDirBinding
                        ...
                        object : FileUtil.CopyDirListener {
                            override fun onSearchProgress(directoryName: String) {
                                viewModel.onUpdateSearchProgress(
                                    AuralisApplication.appContext.resources,
                                    directoryName
                                )
                            }
                            ...
                            override fun onComplete() {
                                AuralisDirectoryHelper.initializeAuralisDirectory(path)
