...
import com.auralis.emulator.EmulationNavigationDirections
...
import com.auralis.emulator.databinding.DialogCheckboxBinding
import com.auralis.emulator.databinding.DialogSliderBinding
import com.auralis.emulator.databinding.FragmentEmulationBinding
import com.auralis.emulator.display.PortraitScreenLayout
import com.auralis.emulator.display.ScreenAdjustmentUtil
...
import com.auralis.emulator.utils.DirectoryInitialization.DirectoryInitializationState
import com.auralis.emulator.utils.EmulationMenuSettings
import com.auralis.emulator.utils.FileUtil
import com.auralis.emulator.utils.GameHelper
import com.auralis.emulator.utils.GameIconUtils
import com.auralis.emulator.utils.EmulationLifecycleUtil
import com.auralis.emulator.utils.Log
import com.auralis.emulator.utils.ViewUtils
import com.auralis.emulator.viewmodel.EmulationViewModel
...
class EmulationFragment : Fragment(), SurfaceHolder.Callback, Choreographer.FrameCallback {
    ...
    override fun onResume() {
        ...
        if (DirectoryInitialization.areAuralisDirectoriesReady()) {
            emulationState.run(emulationActivity.isActivityRecreated)
        } else {
            setupAuralisDirectoriesThenStartEmulation()
        }
    }
    ...
    private fun setupAuralisDirectoriesThenStartEmulation() {
