...
import com.auralis.emulator.features.hotkeys.Hotkey
...
class InputBindingSetting(
    ...
    private val context: Context get() = AuralisApplication.appContext
    ...
    /**
     * Returns the Auralis button code for the settings key.
     */
    ...
    companion object {
        ...
        /**
         * Returns the settings key for the specified Auralis button code.
         */
