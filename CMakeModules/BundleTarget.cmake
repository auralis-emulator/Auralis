...
if (BUNDLE_TARGET_EXECUTE)
    ...
    function(bundle_appimage bundle_dir executable_path source_path binary_path linuxdeploy_executable enable_qt)
        ...
        # Set up app icon
        file(COPY_FILE "${source_path}/dist/auralis.svg" "${CMAKE_BINARY_DIR}/dist/com.auralis.emulator.Auralis.svg")
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} -E env
            ...
            --icon-file "${CMAKE_BINARY_DIR}/dist/com.auralis.emulator.Auralis.svg"
