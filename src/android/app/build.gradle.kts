...
android {
    namespace = "com.auralis.emulator"
    ...
    defaultConfig {
        // The application ID refers to Auralis to allow for
        // the Play Store listing, which was originally set up for Auralis, to still be used.
        applicationId = "com.auralis.emulator"
        minSdk = 29
        targetSdk = 35
