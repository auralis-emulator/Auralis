...
void InitJNI(JNIEnv* env) {
    s_mii_selector_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("com/auralis/emulator/applets/MiiSelector")));
    s_mii_selector_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/auralis/emulator/applets/MiiSelector$MiiSelectorConfig")));
    s_mii_selector_data_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/auralis/emulator/applets/MiiSelector$MiiSelectorData")));

    s_mii_selector_execute =
        env->GetStaticMethodID(s_mii_selector_class, "Execute",
                               "(Lcom/auralis/emulator/applets/MiiSelector$MiiSelectorConfig;)Lorg/"
