...
import com.auralis.emulator.model.CheapDocument
...
object FileUtil {
    ...
    fun DocumentFile.inputStream(): InputStream =
        AuralisApplication.appContext.contentResolver.openInputStream(uri)!!

    fun DocumentFile.outputStream(): OutputStream =
        AuralisApplication.appContext.contentResolver.openOutputStream(uri)!!

    fun Uri.inputStream(): InputStream =
        AuralisApplication.appContext.contentResolver.openInputStream(this)!!

    fun Uri.outputStream(): OutputStream =
        AuralisApplication.appContext.contentResolver.openOutputStream(this)!!

    fun Uri.asDocumentFile(): DocumentFile? =
        DocumentFile.fromSingleUri(AuralisApplication.appContext, this)
