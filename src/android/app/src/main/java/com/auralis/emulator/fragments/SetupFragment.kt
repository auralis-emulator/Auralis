...
import com.auralis.emulator.adapters.SetupAdapter
import com.auralis.emulator.databinding.FragmentSetupBinding
import com.auralis.emulator.features.settings.model.Settings
import com.auralis.emulator.model.ButtonState
import com.auralis.emulator.model.PageButton
import com.auralis.emulator.model.PageState
import com.auralis.emulator.model.SetupCallback
import com.auralis.emulator.model.SetupPage
...
class SetupFragment : Fragment() {
                    ...
                    pageButtons = mutableListOf<PageButton>().apply {
                        add(
                            PageButton(
                                ...
                                buttonAction = {
                                    pageButtonCallback = it
                                    PermissionsHandler.compatibleSelectDirectory(openAuralisDirectory)
                                },
                                buttonState = {
    ...
    private val openAuralisDirectory = registerForActivityResult<Uri, Uri>(
        ...
        AuralisDirectoryHelper(requireActivity(), true).showAuralisDirectoryDialog(result, pageButtonCallback, checkForButtonState)
    }
